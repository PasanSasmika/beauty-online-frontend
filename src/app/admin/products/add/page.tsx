      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input {...register("name")} className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#8B9B86] outline-none" placeholder="e.g. Aloe Vera Gel" />
            ...
            <div className="space-y-2">
              ...
              <input {...register("brand")} className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#8B9B86] outline-none" placeholder="e.g. LotusW" />
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200">
           <div className="flex justify-between items-center mb-6 border-b pb-2">
             ...
             <button type="button" onClick={() => append({ size: '', price: 0, quantity: 100, original_price: undefined })} className="text-sm flex items-center gap-1 text-[#8B9B86] hover:text-[#2D241E] transition-colors font-medium">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-stone-200 space-y-6">
          ...
          <div className="pt-4 border-t border-stone-100">
             <label className="flex items-center gap-3 cursor-pointer">
               <input type="checkbox" {...register("is_koko_enabled")} className="w-5 h-5 accent-[#2D241E]" />
        ...
        <div className="pt-4">
          <button type="submit" disabled={loading} className="w-full bg-[#2D241E] text-white py-4 rounded-xl font-medium hover:bg-stone-800 transition-colors flex items-center justify-center gap-2 disabled:opacity-70">
