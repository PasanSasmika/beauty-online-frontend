...
//   // Brighten the burst for the click effect
//   color.r *= 12.0; 
//   color.g *= 2.0; 
//   color.b *= 4.0;
...
//   // Range 0.95 to 0.99 keeps it in the #ee3f5c (Raspberry/Pink) territory
//   const pinkHue = 0.95 + Math.random() * 0.04; 
//   const c = HSVtoRGB(pinkHue, 0.85, 1.0);
  
//   // Adjusted multipliers to match the intensity of #ee3f5c
//   c.r *= 0.35; 
//   c.g *= 0.08; 
//   c.b *= 0.15;
//   return c;
